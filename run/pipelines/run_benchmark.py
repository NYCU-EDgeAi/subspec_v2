"""Lane-based benchmark pipeline (single-model accuracy/perf)."""
...
def main(builder, benchmarks=None, max_samples=None, lane: str | None = None):
    """Run lane-based benchmark evaluation on specified datasets."""
    reset_seeds(0)
