"""FlashInfer attention wrapper for v3.
...
class FlashinferAttentionWrapper:
    """FlashInfer attention wrapper handling prefill, decode, and tree modes."""
    ...
    def prepareAttention(
        ...
        """Prepare attention for the given mode."""
    ...
    def reshape_qkv_for_attention(self, q, k, v, batchPosition: KvCacheBatchPosition):
        """Reshape QKV tensors for FlashInfer."""
        return (
    ...
    def computeAttention(
        ...
        """Compute attention with KV cache update."""
