"""Attention implementations for FlashInfer v3.
...
from .attention_wrapper import POS_ENCODING_MODE, AttentionRotaryParams
...
class FiLlamaAttention(nn.Module):
    """FlashInfer-accelerated Llama attention."""
...
class FiQwen3Attention(nn.Module):
    """FlashInfer-accelerated Qwen3 attention."""
